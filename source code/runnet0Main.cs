...
string fileName = "wnet0.txt";
string testName = "testnet0.txt";
string testPath = Path.Combine(AppContext.BaseDirectory,"InputForRunnet0", testName);
string filepath = Path.Combine(AppContext.BaseDirectory,"InputForRunnet0", fileName);
...
string outPutPath = Path.Combine(AppContext.BaseDirectory,"OutputForRunnet0", outputFile);
